# ==========================================================
# Age Group Classification using MobileNetV2 (Improved + Fine-tuned + Balanced)
# ==========================================================
...
# ========================== 2. Data Augmentation ==========================
IMG_SIZE = (96, 96)
BATCH_SIZE = 32  # tăng batch size để ổn định hơn
...
print("📊 Phân bố lớp huấn luyện:")
for k, v in counter.items():
    print(f"  Lớp {target_names[k]}: {v} ảnh")
...
# 👉 Fine-tune nhiều hơn (60 lớp cuối)
...
# ========================== 11. Lưu mô hình ==========================
save_path = os.path.join(MODEL_DIR, "mobilenetv2_final_fixed.h5")
